...
export const P2P_MANAGEMENT_ERROR_CODES = [
  ...
  'p2p.credit_exhausted',
  'p2p.destination_rejected',
  'p2p.direct_closed',
  'p2p.direct_unavailable',
  'p2p.duplicate_field',
  'p2p.explicit_stun_required',
  'p2p.frame_scope_mismatch',
  'p2p.helper_configuration_required',
  'p2p.helper_listen_failed',
  'p2p.helper_user_unavailable',
  'p2p.identity_not_verified',
  'p2p.insecure_socket',
  'p2p.invalid_bootstrap',
  'p2p.invalid_candidate',
  'p2p.invalid_credit',
  'p2p.invalid_fields',
  'p2p.invalid_frame',
  'p2p.invalid_json',
  'p2p.invalid_pairing_code',
  'p2p.invalid_result',
  'p2p.invalid_sdp',
  'p2p.invalid_stream_sequence',
  'p2p.lease_expired',
  'p2p.lease_scope_mismatch',
  'p2p.listener_unavailable',
  'p2p.missing_field',
  'p2p.network_revoked',
  'p2p.null_field',
  'p2p.pair_unauthorized',
  'p2p.receive_limit',
  'p2p.redirect_rejected',
  ...
  'p2p.signal_state_conflict',
  'p2p.stream_closed',
  'p2p.stream_failed',
  'p2p.stream_finished',
  'p2p.stream_id_exhausted',
  'p2p.stream_limit',
  'p2p.stream_reset',
  'p2p.streams_closed',
  'p2p.unexpected_data_channel',
  'p2p.unknown_stream',
  'p2p.attempt_not_found',
  'p2p.binding_unauthorized',
  'p2p.certificate_not_expired',
  'p2p.config_unavailable',
  'p2p.device_already_enrolled',
  'p2p.device_busy',
  'p2p.device_unauthorized',
  'p2p.explicit_absolute_path_required',
  'p2p.identity_unavailable',
  'p2p.invalid_challenge',
  'p2p.invalid_config',
  'p2p.invalid_content_type',
  'p2p.invalid_database',
  'p2p.invalid_endpoint',
  'p2p.invalid_enrollment',
  'p2p.invalid_enrollment_token',
  'p2p.invalid_generation',
  'p2p.invalid_https_origin',
  'p2p.invalid_identity',
  'p2p.invalid_name',
  'p2p.invalid_pair_action',
  'p2p.invalid_signal_origin',
  'p2p.invalid_stun_binding',
  'p2p.invalid_user_credentials',
  'p2p.invalid_wss_endpoint',
  'p2p.login_failed',
  'p2p.network_unauthorized',
  'p2p.pair_revoked',
  'p2p.pair_state_conflict',
  'p2p.pairing_busy',
  'p2p.pairing_expired',
  'p2p.path_conflict',
  'p2p.peer_offline',
  'p2p.rate_limited',
  'p2p.renewal_not_due',
  'p2p.request_conflict',
  'p2p.request_interrupted',
  'p2p.sdp_binding_mismatch',
  'p2p.signal_limit',
  'p2p.state_already_exists',
  'p2p.state_unavailable_or_insecure',
  'p2p.tls_required',
  'p2p.tls_unavailable',
  'p2p.unknown_operation',

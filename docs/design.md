...
reduced-motion behavior. Product copy belongs in
\`src/app/shared/i18n/i18n.ts\`. The shell keeps application navigation separate
from disabled workspace management features until a real workspace registry is
available.

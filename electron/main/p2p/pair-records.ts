 ...
 * that belongs to two other devices. Refusing the whole reply for one of them
 * would turn an unrelated leftover row into a failed read of the pairs that do
 * belong here, which are still validated exactly as before; a duplicate pair id
 * is still refused.
 */

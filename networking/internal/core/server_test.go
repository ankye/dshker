...
func TestHandleAnswersVersion(t *testing.T) {
	...
	expected := []string{"core.version", "core.catalog_commit", "core.catalog_enable", "core.catalog_inspect", "core.catalog_remove_service", "core.install_catalog_commit", "core.install_catalog_inspect", "core.roots_commit", "core.roots_inspect", "core.secret_delete", "core.secret_get", "core.secret_set", "remote.broker_start", "remote.broker_status", "remote.broker_stop", "remote.connect", "remote.disconnect", "remote.status", "runtime.console", "runtime.port_get", "runtime.port_set", "runtime.start", "runtime.status", "runtime.stop"}
